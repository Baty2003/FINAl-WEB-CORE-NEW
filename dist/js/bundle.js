...
/* harmony import */ var _showMore__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./showMore */ "./src/js/showMore.js");
/* harmony import */ var _openMobileMenus_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./openMobileMenus.js */ "./src/js/openMobileMenus.js");




Object(_showMore__WEBPACK_IMPORTED_MODULE_2__["initLessMoreButton"])('description', 8);
Object(_showMore__WEBPACK_IMPORTED_MODULE_2__["initLessMoreButton"])('repair-different-techniques', 3);
Object(_slider_js__WEBPACK_IMPORTED_MODULE_0__["startSwiper"])();
Object(_openMobileMenus_js__WEBPACK_IMPORTED_MODULE_3__["buttonListenerOpenMenus"])();

/***/ }),

/***/ "./src/js/openMobileMenus.js":
/*!***********************************!*\
  !*** ./src/js/openMobileMenus.js ***!
  \***********************************/
/*! exports provided: buttonListenerOpenMenus */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "buttonListenerOpenMenus", function() { return buttonListenerOpenMenus; });
var buttonOpenMobileMenu = document.getElementById('buttonOpenMobileMenu');
var buttonCloseMobileMenu = document.getElementById('buttonCloseMobileMenu');
var mobileMenu = document.querySelector('.mobile-menu');
var flexContent = document.querySelector('.flex-container__content');
var buttonOpenFeedback = document.getElementById('buttonOpenFeedbackMenu');
var buttonCloseFeedback = document.getElementById('buttonCloseFeedbackMenu');
var feedbackMenu = document.getElementById('feedbackMenu');
var buttonOpenOrderCallMenu = document.getElementById('buttonOpenOrderCallMenu');
var buttonCloseOrderCallMenu = document.getElementById('buttonCloseOrderCallMenu');
var OrderCallMenu = document.getElementById('orderCallMenu');

var buttonListenerOpenMenus = function buttonListenerOpenMenus() {
...
/*!****************************!*\
  !*** ./src/js/showMore.js ***!
  \****************************/
/*! exports provided: initLessMoreButton */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initLessMoreButton", function() { return initLessMoreButton; });
...
var initLessMoreButton = function initLessMoreButton(idSectionWithButtons, countHiddenElements) {
  var sectionWithButtons = document.getElementById(idSectionWithButtons);
  var buttonLess = sectionWithButtons.querySelector('.section__read-more--less');
  var buttonMore = sectionWithButtons.querySelector('.section__read-more--show');
  var containersElements = sectionWithButtons.querySelector('.swiper-wrapper');

  if (!buttonLess || !buttonMore || !containersElements) {
    return;
  }

  var elemsHidden = containersElements.querySelectorAll(".swiper-slide:nth-child(".concat(countHiddenElements, ") ~ .swiper-slide:not(.swiper-slide-duplicate-prev, .swiper-slide-duplicate-active,.swiper-slide-prev,.swiper-slide-active, .swiper-slide-next)"));

  if (breakpoint.matches === true) {
    var _iterator = _createForOfIteratorHelper(elemsHidden),
        _step;
  ...
  buttonMore.addEventListener('click', function () {
    var _iterator2 = _createForOfIteratorHelper(elemsHidden),
        _step2;

    try {
      for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
        var _elem = _step2.value;
        _elem.style.display = 'inherit';
      }
    } catch (err) {
      _iterator2.e(err);
    } finally {
  ...
  buttonLess.addEventListener('click', function () {
    var _iterator3 = _createForOfIteratorHelper(elemsHidden),
        _step3;
  ...
  window.addEventListener('resize', function () {
    if (breakpoint.matches === true) {
      var _iterator4 = _createForOfIteratorHelper(elemsHidden),
          _step4;
      ...
      var _iterator5 = _createForOfIteratorHelper(elemsHidden),
          _step5;

      try {
        for (_iterator5.s(); !(_step5 = _iterator5.n()).done;) {
          var _elem4 = _step5.value;
          _elem4.style.display = null;
...
/*!**************************!*\
  !*** ./src/js/slider.js ***!
  \**************************/
/*! exports provided: startSwiper */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "startSwiper", function() { return startSwiper; });
...
var swipersContainers = document.querySelectorAll('.swiper');
var swipers = [];
var breakpoint = window.matchMedia('(min-width:768px)');

function createSwiper(elem) {
  var swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](elem, {
    swiperPerView: 'auto',
    loop: true,
    spaceBetween: -20,
    pagination: {
...
var breakpointChecker = function breakpointChecker() {
  if (breakpoint.matches === true) {
    var _iterator = _createForOfIteratorHelper(swipers),
        _step;
    ...
    if (swipers.length !== 0) {
      ...
      var _iterator2 = _createForOfIteratorHelper(swipersContainers),
          _step2;
...
function startSwiper() {
  if (breakpoint.matches === false) {
    var _iterator3 = _createForOfIteratorHelper(swipersContainers),
        _step3;
